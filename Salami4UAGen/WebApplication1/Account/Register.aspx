        ...
        <div class="accountInfo">
            <fieldset class="register" style="background-color: #FBFDFF">
                ...
                <p>
                    ...
                    <br /><br />
                    <asp:RadioButtonList ID="Genre" runat="server"> </asp:RadioButtonList>
                ...
                <p>
                    <asp:Label ID="LabelInterested" runat="server" Text="Interested in" Font-Bold="True" 
                        Font-Names="Tahoma" Font-Size="Medium" ForeColor="Silver"></asp:Label>
                    <br /><br />
                    <asp:RadioButtonList ID="GenreInterested" runat="server"> </asp:RadioButtonList>
            ...
            <p class="submitButton" style="text-align: left; margin-left: 5%;">
                <asp:Button ID="Continuar" runat="server" class='button' CommandName="MoveNext" Text="Continue" OnClick="Continuar_Click"
                        ValidationGroup="RegisterUserValidationGroup"/>
            </p>
        </div>
